...
#df = ROOT.RDataFrame("sampled_ReE", "/media/lily/Data/GPDs/TMVA_ANN-global/CFFs_Model_FromKM15/PseudoMapFit/sampled_ReE_XMapCF_KM15_5pct.root") #with 425000 sets (sampling ReE)
...
# df = ROOT.RDataFrame("sampled_ReE", "./replicas/sampled_ReE_xmi_data_5pct.root") # 100 replicas per set
# replica_no = 0
...
ReE_array = np.array(dfcols['xmi_ReE'])
...
# # Kinematic input to predict ReE
...
# ReE_tf = hypermodel.predict(best_hypermodel2, kin_array_in)

# print("kin in array shape: \n", kin_array_in.shape)
# print("ReE tf array shape: \n", ReE_tf.shape)

# df_plots = ROOT.RDF.MakeNumpyDataFrame({"QQ":df_in_cols['QQ'],"xB":df_in_cols['xB'],"t":df_in_cols['t'],"ReE_km15":df_in_cols['ReE_km15'],"ReE_tf":ReE_tf}) 
# df_plots.Display().Print()
# # print(ReE_tf)

# # 1D graphs ReE vs t 
# gr_ReE_vs_t_tf = df_plots.Filter("xB > 0.34 && xB < 0.35").Graph("t", "ReE_tf")
# gr_ReE_vs_t_km15 = df_plots.Filter("xB > 0.34 && xB < 0.35").Graph("t", "ReE_km15")
# gr_ReH_vs_t_tf.Sort()
